...
void main() {
  group('Mock Authenticatoin', () {
    ...
    test("Create user should delegate to logIn functon", () async {
      final badEmailUser =
          provider.createUser(email: "foo@bar.com", password: "any password");
      expect(badEmailUser,
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(email: 'foobar', isEmailVerified: true);
    _user = newUser;
  }
}
